  ...
  return(
    <AppBar position="fixed" style={{zIndex: 1202, flexWrap:'wrap', width:'100%', maxWidth: '100%'}}>
      <Toolbar style={{flexWrap:'wrap', maxWidth: '100%'}} id='toolbar'>
        ...
        <Tabs value={props.input ? 0:1} className='tabContainer'  variant='fullWidth' id='menuTabs'>
          <Tab
            label={<span><EditIcon
            style={{verticalAlign:'middle',top:'0px'}}/>&nbsp;&nbsp; Input</span>}
            style={{flexGrow: 1}}
            className='tab'
            component={Link}
            to="/input"
          ...
          <Tab
            id='resultsTab'
            label={<span><FireIcon style={{verticalAlign:'middle'}}/>&nbsp;&nbsp; Results</span>}
            style={{flexGrow: 1}}
            component={Link}
            to="/results"
          />
